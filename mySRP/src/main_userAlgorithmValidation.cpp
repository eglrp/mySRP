 ...
 */
GVector mybilinear_interp(double x_grid[181][361],double y_grid[181][361],double z_grid[181][361],
...
GVector bilinear_interp(double x_grid[181][361],double y_grid[181][361],double z_grid[181][361],
                     double longitude, double latitude)
{
    double min_longitude = -180, max_longitude = 180;
    double min_latitude = -90, max_latitude = 90;
...
int main(int argc, char* argv[])
{
    ...
    //userfile
//    argv[1] = "/Users/lizhen/projects/mySRP/mySRP/GalileoIOV/GalileoIOV.txt";
//    // reflection number
//    argv[2] = "1";
//    // pixel resolution
//    argv[3] = "0.01";
...
//    argv[4] = "100";
//
//    argv[5] = "/Users/lizhen/projects/mySRP/mySRP/GalileoIOV/xgrid_GalileoIOV.grd";
//    argv[6] = "/Users/lizhen/projects/mySRP/mySRP/GalileoIOV/ygrid_GalileoIOV.grd";
//    argv[7] = "/Users/lizhen/projects/mySRP/mySRP/GalileoIOV/zgrid_GalileoIOV.grd";
//    argv[8] = "696.815";
    ...
    for(int i = 0 ; i< N; i++ )
    {
       ...
       GVector force_grid =  bilinear_interp(data_x, data_y, data_z, lon_N[i], lat_N[i]);
       //GVector force_grid = mybilinear_interp(data_x, data_y, data_z, lon_N[i], lat_N[i]);
        ...
        //myraytracer.pixelarray.buildPixelArray(-0.1*M_PI/180, 145*M_PI/180.0, myraytracer.objects.boundingBox);
    ...
    for(int i = 0 ; i< N; i++ )
    {
        fprintf(pf, "%12.5f,%12.5f,%20.12E,%20.12E,%20.12E\n",
                    lat_N[i],lon_N[i],diff[i].x,diff[i].y,diff[i].z);
    }
    fclose(pf);
