...
class KDNode {
 public:
  ...
  double
      splitPos;  // the split position, x = splitPos, y=splitPos or z=splitPos
...
/* the kd tree class
 ...
 !!!!!!!                 !!!!!!
 !!!!!!!  very important !!!!!!
    because I am using unique_prt, after building the tree, all the memroy in
 GScene::objects will be released, GRayTracer:: objects is not accessable any
 more !!!!!! every operation on the objects should through the tree!!!!!!!
 **************************************************************************************************
