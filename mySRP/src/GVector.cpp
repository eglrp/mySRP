...
namespace gfc {
// Default constructor
GVector::GVector() { set(0.0, 0.0, 0.0); }
...
void GVector::set(double in_x, double in_y,
                  double in_z) {  // assign specific values
  x = in_x;
  y = in_y;
  z = in_z;
}

bool GVector::operator==(gfc::GVector a) {
...
bool GVector::operator!=(gfc::GVector a) { return !(*this == a); }

GVector GVector::operator-() const { return GVector(-x, -y, -z); }
...
double GVector::norm() const { return sqrt(norm2()); }
